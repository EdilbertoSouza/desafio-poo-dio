...
<p> Sejam bem-vindos ao meu projeto do desafio: <strong>APRENDENDO NA PRÁTICA O PARADIGMA DE ORIENTAÇÃO A OBJETOS.</strong><br>Desafio este que tive a oportunidade de participar na plataforma de cursos online <strong><a href="https://web.digitalinnovation.one/">DIGITAL INNOVATION ONE</a></strong> 💛🧡 e praticar conceitos e conteúdos vistos no: Cloud Fullstack Bootcamp - Warburg Pincus disponibilizado de forma gratuita para a comunidade dos desenvolvedores.<br>
💎 O objetivo principal desse projeto é colocar em prática umas das principais ferramentas da OO: <strong>ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO,</strong> através de um projeto Java. </p>

<h2>🛑 Funcionalidades Adicionais </h2>

Para isso, foi tomado como base (fork) o projeto original da instrutora e desenvolvedora Camila e adicionado as seguintes funcionalidades:

* Criado método para listagem dos Devs inscritos no Bootcamp;      
* Criado método para listagem dos conteúdos concluídos por Dev;
* Criado método para listagem do Ranking do Bootcamp (utilizando o totalXp em ordem decrescente);
* Criado método para imprimir Certificado de Conclusão para os Devs que concluíram todos os conteúdos.

<h2>🛑 Pré-Requisitos</h2>

<p>
✅ Conhecer a sintaxe da Java<br>
✅ Java JDK 11 ou superior (Nesse Projeto usei a JDK 17)<br>
...
Disponibilizado por [Edilberto](https://www.linkedin.com/in/edilberto-lima-de-souza-58151035/ "Edilberto").
